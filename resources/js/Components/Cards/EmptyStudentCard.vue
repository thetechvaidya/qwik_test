    ...
    <div class="flex flex-col items-center justify-center gap-4 text-gray-600">
        ...
        >
            ...
            <path
                ...
                fill="#00bfa6"
            />
            <ellipse cx="374.17" cy="814.05" rx="118.88" ry="19.93" fill="#00bfa6" opacity="0.1" />
            <ellipse cx="608.16" cy="661.06" rx="118.88" ry="19.93" fill="#00bfa6" opacity="0.1" />
            <polygon
            ...
            <path
                ...
                opacity="0.1"
            />
            <ellipse cx="90.82" cy="763.14" rx="44.18" ry="8.64" fill="#00bfa6" opacity="0.1" />
            <ellipse cx="827.28" cy="706.15" rx="32.18" ry="6.29" fill="#00bfa6" opacity="0.1" />
            <ellipse cx="966.77" cy="731.64" rx="32.18" ry="6.29" fill="#00bfa6" opacity="0.1" />
            <ellipse cx="750.78" cy="784.14" rx="32.18" ry="6.29" fill="#00bfa6" opacity="0.1" />
            <path
            ...
            <path
                ...
                fill="#ffd037"
            />
            <ellipse cx="113.46" cy="643.07" rx="75.65" ry="11.61" fill="#00bfa6" opacity="0.1" />
            <path
            ...
            <circle cx="179.99" cy="124.52" r="31.5" fill="#00bfa6" opacity="0.1" />
            <circle cx="113.99" cy="49.52" r="19.5" fill="#00bfa6" opacity="0.1" />
            <circle cx="12" cy="93.02" r="12" fill="#00bfa6" opacity="0.1" />
        </svg>
