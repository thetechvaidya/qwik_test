<template>
    <div class="overflow-y-auto h-screen px-2">
        ...
        <form v-else class="my-6 w-11/12 mx-auto xl:w-full xl:mx-0" @submit.prevent="submitForm">
            ...
            <small v-if="formValidated && selected_sections.length === 0" id="sections-error" class="p-invalid"
                >{{ __('Please choose at least one section') }}.</small
            >
    ...
    methods: {
        ...
        update() {
            ...
            if (this.selected_sections.length > 0) {
                this.$inertia.post(
                    route('update_sub_category_sections', { id: this.subCategoryId }),
        ...
        fetchSections() {
            ...
            _this.loading = true
            axios
                .get(route('fetch_sub_category_sections', { id: this.subCategoryId }))
