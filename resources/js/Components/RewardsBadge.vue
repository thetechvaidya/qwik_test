<template>
    <div class="flex group gap-2 items-center">
        <svg
:class="iconSize" class="transition duration-300 ease-in-out transform group-hover:scale-110" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="300px"
            ...
            <g><ellipse fill="#FFC843" cx="149.833" cy="149.501" rx="147.833" ry="146.166"/><ellipse fill="#D38700" cx="150" cy="150.168" rx="113.667" ry="113.833"/>
                <polygon
fill="#FFC843" points="192.716,211.945 151.021,190.203 109.476,212.222 117.27,165.852 83.489,133.142 129.999,126.226
