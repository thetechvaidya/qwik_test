<template>
    <app-layout>
        ...
        <template #actions>
            <a
                :href="route('download_exam_report', { exam: exam.slug, session: session.code })"
                target="_blank"
                ...
                <div class="w-full bg-white dark:bg-gray-800 rounded shadow overflow-scroll">
                    <table class="w-full table-auto">
                        ...
                        <tr v-for="section in sections" :key="'section_' + section.sno">
                            ...
                            <td class="border px-8 py-2">
                                <span class="text-sm"
                                    >{{ section.results.score }}/{{ section.results.total_marks }}</span
                                >
                            </td>
                            <td class="border px-8 py-2">
                                <span class="text-sm"
                                    >{{ section.results.answered_questions }}/{{
                                        section.results.total_questions
                                    }}</span
                                >
                            </td>
                            <td class="border px-8 py-2">
...
const title = computed(() => {
    return props.exam.title + ' ' + __('Results') + ' - ' + pageProps.general.app_name
})
...
const jumpToSection = sectionId => {
    // Implementation for section jumping if needed
}
</script>
