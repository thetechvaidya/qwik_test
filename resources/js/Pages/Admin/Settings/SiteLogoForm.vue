    ...
    <arc-form-section @submitted="updateSettings">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                <input id="logo" ref="logo" type="file" class="hidden" name="logo" @change="updateLogoPreview" />
...
const updateSettings = () => {
    if (logo.value) {
        form.logo_path = logo.value.files[0]
    }

    form.post(route('update_logo'), {
        errorBag: 'updateLogo',
        preserveScroll: true,
    })
}
...
const updateLogoPreview = () => {
    ...
    logoReader.readAsDataURL(logo.value.files[0])
}
</script>
