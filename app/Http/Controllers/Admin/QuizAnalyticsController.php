...
class QuizAnalyticsController extends Controller
{
    ...
    public function overallReport(Quiz $quiz)
    {
        ...
        return Inertia::render('Admin/Quiz/OverallReport', [
            'quiz' => $quiz->only('id', 'code', 'title', 'slug'),
    ...
    /**
     * Delete User Quiz Session
     *
     * @param Quiz $quiz
     * @param $session
     * @return \Illuminate\Http\RedirectResponse
     */
    public function deleteSession(Quiz $quiz, $session)
    {
        $session = QuizSession::where('code', $session)->firstOrFail();
        ...
        try {
            ...
            return redirect()->back()->with('errorMessage', 'Something went wrong! Unable to delete quiz session. Please try again later.');
        }
        return redirect()->back()->with('successMessage', 'Quiz session was successfully deleted!');
    }
}
