...
if (!function_exists('isValidQuestionType')) {
    /**
    ...
    {
        $validTypes = ['mcq', 'true_false', 'short_answer', 'essay', 'matching', 'ordering', 'fill_blank'];
        return in_array($type, $validTypes);
    }
}

if (!function_exists('calculateQuestionDifficulty')) {
    /**
     * Calculate question difficulty based on responses
     * @param int $questionId
     * @return string
     */
    function calculateQuestionDifficulty($questionId)
    {
        // Mock implementation - in real app would analyze answer statistics
        $difficulties = ['easy', 'medium', 'hard'];
        return $difficulties[array_rand($difficulties)];
    }
}

if (!function_exists('calculateQuestionScore')) {
    /**
     ...
     * @return float
     */
    function calculateQuestionScore($questionId, $isCorrect)
    {
...
if (!function_exists('sanitizeQuestionContent')) {
    /**
    ...
    {
        return strip_tags($content, '<p><strong><em><u><ol><ul><li>');
    }
}
